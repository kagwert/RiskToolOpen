        ...
        function onLoadBloomberg(app)
            ...
            try
                ...
                for i = 1:numel(bbgTickers)
                    ...
                    drawnow;
                    try
                        bbgOverrides = {'periodicitySelection',    bbgFreq; ...
                                        'periodicityAdjustment',   'CALENDAR'; ...
                                        'nonTradingDayFillOption', 'ALL_CALENDAR_DAYS'; ...
                                        'nonTradingDayFillMethod', 'PREVIOUS_VALUE'};
                        d = history(c, bbgTickers{i}, bbgField, d1, d2, bbgOverrides);
        ...
        function onLoadBloombergMacro(app)
            ...
            try
                ...
                for i = 1:numel(parsedTickers)
                    ...
                    drawnow;
                    try
                        macroOverrides = {'periodicitySelection',    parsedFreqs{i}; ...
                                          'periodicityAdjustment',   'CALENDAR'; ...
                                          'nonTradingDayFillOption', 'ALL_CALENDAR_DAYS'; ...
                                          'nonTradingDayFillMethod', 'PREVIOUS_VALUE'};
                        d = history(c, parsedTickers{i}, 'PX_LAST', d1, d2, macroOverrides);
                        if isempty(d) || size(d,1) < 2
